    ...
    <Container>
      ...
      <div className='flex justify-between'>
          <div className='flex space-x-[49px]'>
            ...
            <div className="relative after:content-[''] after:absolute after:top-1 after:left-[-27px] after:h-[16px] after:w-[2px] after:bg-red-500 flex items-center space-x-[5px]">
